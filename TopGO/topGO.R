...
topGO_object <- function(filePath, geneUniverse, geneID2GO, GOdescription) {
  ...
  # Create topGO object
  sp_GO <- new("topGOdata", description=GOdescription, ontology="MF", allGenes=geneList, annot=annFUN.gene2GO, gene2GO=geneID2GO)
...
geneID2GO_ppat <- readMappings(file="ppat_V3.3_annot.txt")
...
GO_results(sp_GO = ppat_spor_GO, outFile = "Ppat_sporo_topGO_MF.csv")
GO_results(sp_GO = ppat_gam_GO, outFile = "Ppat_gam_topGO_MF.csv")
...
# Complete statistical analysis
GO_results(sp_GO = aagr_spor_GO, outFile = "Aagr_sporo_topGO_MF.csv")
GO_results(sp_GO = aagr_gam_GO, outFile = "Aagr_gam_topGO_MF.csv")
...
# Complete statistical analysis
GO_results(sp_GO = pamo_spor_GO, outFile = "Pamo_sporo_topGO_CC.csv")
GO_results(sp_GO = pamo_gam_GO, outFile = "Pamo_gam_topGO_CC.csv")
#-------------------------------------------------------------------------------

# Dryopteris ludoviciana

# Importing files for topGO
geneID2GO_dlud <- readMappings(file="Dlud_annot.txt")
geneUniverse_dlud <- names(geneID2GO_dlud)

# Create TopGO object
dlud_spor_GO <- topGO_object(filePath = "Dlud_sporo_upreg.txt",
                             geneUniverse = geneUniverse_dlud,
                             geneID2GO = geneID2GO_dlud,
                             GOdescription = "Dryopteris ludoviciana upregulated genes in sporophyte")

dlud_gam_GO <- topGO_object(filePath = "Dlud_gameto_upreg.txt",
                            geneUniverse = geneUniverse_dlud,
                            geneID2GO = geneID2GO_dlud,
                            GOdescription = "Dryopteris ludoviciana upregulated genes in gametophyte")

# Complete statistical analysis
GO_results(sp_GO = dlud_spor_GO, outFile = "dlud_sporo_topGO_CC.csv")
GO_results(sp_GO = dlud_gam_GO, outFile = "dlud_gam_topGO_CC.csv")
...
# Complete statistical analysis
GO_results(sp_GO = ptab_spor_GO, outFile = "ptab_sporo_topGO_cc.csv")
GO_results(sp_GO = ptab_gam_GO, outFile = "ptab_gam_topGO_cc.csv")
...
# Complete statistical analysis
GO_results(sp_GO = atha_spor_GO, outFile = "Atha_sporo_topGO_MF.csv")
GO_results(sp_GO = atha_gam_GO, outFile = "atha_gam_topGO_MF.csv")
